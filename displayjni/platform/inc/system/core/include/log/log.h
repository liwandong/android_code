...
#define SLOGD_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_SYSTEM, ANDROID_LOG_DEBUG, LOG_TAG, __VA_ARGS__)) \
                             : (void)0)
#endif
...
#define SLOGI_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_SYSTEM, ANDROID_LOG_INFO, LOG_TAG, __VA_ARGS__))  \
                             : (void)0)
#endif
...
#define SLOGW_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_SYSTEM, ANDROID_LOG_WARN, LOG_TAG, __VA_ARGS__))  \
                             : (void)0)
#endif
...
#define SLOGE_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_SYSTEM, ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)) \
                             : (void)0)
#endif
...
#define RLOGD_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_RADIO, ANDROID_LOG_DEBUG, LOG_TAG, __VA_ARGS__))  \
                             : (void)0)
#endif
...
#define RLOGI_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_RADIO, ANDROID_LOG_INFO, LOG_TAG, __VA_ARGS__))   \
                             : (void)0)
#endif
...
#define RLOGW_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_RADIO, ANDROID_LOG_WARN, LOG_TAG, __VA_ARGS__))   \
                             : (void)0)
#endif
...
#define RLOGE_IF(cond, ...)                                                                                            \
    ((__predict_false(cond)) ? ((void)__android_log_buf_print(LOG_ID_RADIO, ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__))  \
                             : (void)0)
#endif
...
#define LOG_ALWAYS_FATAL_IF(cond, ...)                                                                                 \
    ((__predict_false(cond)) ? ((void)android_printAssert(#cond, LOG_TAG, ##__VA_ARGS__)) : (void)0)
#endif
...
#define LOG_EVENT_FLOAT(_tag, _value)                                                                                  \
    {                                                                                                                  \
        ...
        (void)android_btWriteLog(_tag, EVENT_TYPE_FLOAT, &floatBuf, sizeof(floatBuf));                                 \
    }
#endif
...
#define android_vprintLog(prio, cond, tag, fmt...) __android_log_vprint(prio, tag, fmt)
...
#define CDFINGER_LOG(fmt, args...)                                                                                     \
    do                                                                                                                 \
    {                                                                                                                  \
        printf("\n%s: " fmt, __func__, ##args);                                                                        \
    } while (0)

#define ALOGI(...) CDFINGER_LOG(__VA_ARGS__)
#define ALOGD(...) CDFINGER_LOG(__VA_ARGS__)
#define ALOGW(...) CDFINGER_LOG(__VA_ARGS__)
#define ALOGE(...) CDFINGER_LOG(__VA_ARGS__)
#endif
